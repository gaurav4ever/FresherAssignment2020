...
public class UserUtil {
  ...
  public void start() {
    ...
    userRecFileName = service.getFile();
    userRecordList = service.readFile(
        "/Users/vishalsinghal/Desktop/nuclei_assignment/FresherAssignment2020/usersData.txt");
    ...
    while (true) {
      ...
      switch (t) {
        ...
        case 2:
          ...
          sc.nextLine();
          System.out.println("Press -> 's' for sorting menu. (Any other key for main menu)");
        ...
        case 3:
          ...
          break;
        case 4:
          service.writeFile(userRecordList, userRecFileName);
          break;
        case 5:
          sc.nextLine();
