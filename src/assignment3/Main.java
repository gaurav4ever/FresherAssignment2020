...
public class Main{
  ...
  public static void main(String args[]){
    ...
    while(flag){
      ...
      " 3. Delete Dependency\n"+
      " 4. Get Immediate Parent of a Node\n"+
      " 5. Get Immediate Child of a Node\n"+
      " 6. Get Ancestors of a Node\n"+
      " 7. Get Decedents of a Node\n"+
      " 8. Delete a Node\n"+
      " 0. Exit\n"
      );
      ...
      switch(choice){
        ...
        case 7: 
          ...
          nodeId = sc.nextInt();
          try{
            TreeSet<Node> decedents = treeObj.getDecedents(nodeId, new TreeSet<Node>());
            System.out.println(decedents);
          }catch(Exception e){
            e.printStackTrace();
          }
          break;
