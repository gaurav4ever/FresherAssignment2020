        ...
        try {
            ...
            while (rs != null && rs.next()) {
                ...
                switch(rs.getString(Strings.type)){
                    case Strings.raw : item = new RawItem(rs.getString(Strings.name) , rs.getDouble(Strings.price))  ;break ;
                    case Strings.imported: item = new ImportedItem(rs.getString(Strings.name) , rs.getDouble(Strings.price))  ;break ;
                    case Strings.manufactured : item = new ManufacturedItem(rs.getString(Strings.name) , rs.getDouble(Strings.price))  ;break ;
                    default:
