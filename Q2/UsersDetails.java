...
public class UsersDetails implements Serializable {
    ...
    public void displayAllUserSortedByNameAsc() {
        rollnoToUserMap.values().stream().sorted(new UserComparatorByNameAsc()).forEach(System.out::println);
    }

    public void displayAllUserSortedByNameDesc() {
        rollnoToUserMap.values().stream().sorted(new UserComparatorByNameDesc()).forEach(System.out::println);
    }
    ...
    public void displayAllUserSortedByRollnoDesc() {
        rollnoToUserMap.values().stream().sorted(new UserComparatorByRollnoDesc()).forEach(System.out::println);
    }

    public void displayAllUserSortedByAddressAsc() {
        rollnoToUserMap.values().stream().sorted(new UserComparatorByAddressAsc()).forEach(System.out::println);
    }

    public void displayAllUserSortedByAddressDesc() {
        rollnoToUserMap.values().stream().sorted(new UserComparatorByAddressDesc()).forEach(System.out::println);
    }

    public void displayAllUserSortedByAgeAsc() {
        rollnoToUserMap.values().stream().sorted(new UserComparatorByAgeAsc()).forEach(System.out::println);
    }

    public void displayAllUserSortedByAgeDesc() {
        rollnoToUserMap.values().stream().sorted(new UserComparatorByAgeDesc()).forEach(System.out::println);
    }
