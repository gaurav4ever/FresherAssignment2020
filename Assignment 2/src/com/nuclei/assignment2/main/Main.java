	...
	public static void main(String args[]) {
		...
		while(true) {
			...
			case 2:	System.out.println("----------------------------------------------------------------------------------------------------");
					...
					break;
			case 3: System.out.println("Enter the Roll Number to delete");
					String dRoll = sc.nextLine();
					Student remove = null;
					boolean found = false;
					for(Student student : students) {
						if(student.getRollNo().equals(dRoll)) {
							found = true;
							remove = student;
						}
					}
					...
					break;
			case 4: StudentService.saveService(students);
					break;
			case 5: System.out.println("Do you want to save the details before exit? y/n");
