...
public class UserService {
	...
	/*
	 * This method take the user object, checks whether it a user with 
	 * given roll exists, if so throws an exception else adds the user and 
	...
	/*
	 * this methods takes the attribute and sorting order as parameters
	 * and returns the corresponding sorted list.
	 */
	public List<User> getSortedUserDetails(int choice, char sortOrder) {
		...
		case 1:
			...
			else Collections.sort(tempUserList, new NameDescComparator());
			break;
		case 2:
			if(sortOrder=='a') {
				Collections.sort(tempUserList, new RollNoAscComparator());
			}
			else Collections.sort(tempUserList, new RollNoDescComparator());
			break;
		case 3:
			if(sortOrder=='a') {
				Collections.sort(tempUserList, new AgeAscComparator());
			}
			else Collections.sort(tempUserList, new AgeDescComparator());
			break;
		case 4:
			if(sortOrder=='a') {
				Collections.sort(tempUserList, new AddressAscComparator());
			}
			else Collections.sort(tempUserList, new AddressDescComparator());
			break;
	...
	/*
	 * If the user exists with the given roll number this method 
	 * deletes the user
	 */
	...
	public List<User> nameAndRollNoSort(List<User> userList){
	 ...
	 /* 
	 * public List<User> nameDescSort(List<User> userList){
	 * Collections.sort(userList, new NameDescComparator()); return userList; }
	 * 
	 * public List<User> nameAscSort(List<User> userList){
	 * Collections.sort(userList, new NameAscComparator()); return userList; }
	 * 
	 * public List<User> rollNoAscSort(List<User> userList){
	 * Collections.sort(userList, new RollNoAscComparator()); return userList; }
	 * 
	 * public List<User> rollNoDescSort(List<User> userList){
	 * Collections.sort(userList, new RollNoDescComparator()); return userList; }
	 * 
	 * public List<User> addressAscSort(List<User> userList){
	 * Collections.sort(userList, new AddressAscComparator()); return userList; }
	 * 
	 * public List<User> addressDescSort(List<User> userList){
	 * Collections.sort(userList, new AddressDescComparator()); return userList; }
	 * 
	 * public List<User> ageAscSort(List<User> userList){ Collections.sort(userList,
	 * new AgeAscComparator()); return userList; }
	 * 
	 * public List<User> ageDescSort(List<User> userList){
	 * Collections.sort(userList, new AgeDescComparator()); return userList; }
	 */
}
