...
import asgn.service.impl.ServiceSortRecordNameAge;
import asgn.service.impl.SortRecordByAge;
import asgn.service.impl.SortRecordByName;
import asgn.service.impl.SortRecordByRollNumber;
...
public class ServiceOperations {
  ...
  public List<Student> sortByChoice(List<Student> studentRecordList, int choice) {
    ...
    switch (choice) {
      ...
      case 3:
        ...
        break;
      case 4:
        comparator = new ServiceSortRecordNameAge.SortRecordByAddress()
            .sortStudentRecord(studentRecordList);
        break;
    }
  ...
  public void saveUserDetails(List<Student> studentRecordList, String studentRecFileName) {
    if (studentRecordList == null) {
      ...
      StudentFileReadWrite
          .writeFile(serviceSortRecordNameAge.sortByNameAge(studentRecordList), studentRecFileName);
  ...
  public void deleteUserDetails(List<Student> studentRecordList, String studentRecFileName) {
    ...
    for (int i = 0; i < studentRecordList.size(); i++) {
      if (studentRecordList.get(i).getRollNumber()
          == deleteRno) { // check for matching roll number in the
        // records
